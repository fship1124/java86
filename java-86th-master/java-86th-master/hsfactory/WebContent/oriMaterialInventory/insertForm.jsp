...
<div id = "container">
<form name="inventoryInsert" action="${pageContext.request.contextPath}/oriMaterialInventoryInsert.do" method="post">
	<div id = "ribbon">
		<div id="ribbonMap">
			홈 > 재고관리 > 원자재재고 > 등록
		</div>
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/oriMaterialInventoryInsertForm.do'; return false;">REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/oriMaterialInventoryList.do'; return false;">BACK</button>
