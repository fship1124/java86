...
<div id = "container">
	<div id = "ribbon">
		...
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/oriMaterialInventoryList.do'">REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/oriMaterialInventoryInsertForm.do'">+NEW</button>
		</div>
	</div>
...
<script>
	$(".delTag").click(function () {
		if (confirm("삭제하시겠습니까?")) {
			location.href="${pageContext.request.contextPath}/oriMaterialInventoryDelete.do?deleteInventoryId=" + $(this).attr("type-data");
		};
	});
</script>
