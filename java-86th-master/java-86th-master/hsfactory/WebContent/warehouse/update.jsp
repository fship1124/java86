...
<div id = "container">
	<form action="${pageContext.request.contextPath}/warehouseUpdate.do"
	      method="post">
	      <input type="hidden" value="${Warehouse.wHouseId}"/>
	<div id = "ribbon">
		<div id="ribbonMap">
			홈 > 창고 관리 > 창고 > 창고정보 수정
		</div>
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/warehouseUpdate.do?wHouseId=${Warehouse.wHouseId}'; return false";>REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/warehouseList.do'; return false;">+LIST</button>
			<input type="submit" value="UPDATE" />
			<button onclick="location.href='${pageContext.request.contextPath}/warehouseUpdate.do?wHouseId=${Warehouse.wHouseId}'; return false;">CANCLE</button>
	...
	<div id = "content">
		<table id="companyTable">
			<tr>
				<th>창고명</th>
				<td><input type="text" name="wHouseName"value="<c:out value="${Warehouse.wHouseName}"></c:out>"/> </td>
				<th>창고 유형</th>
