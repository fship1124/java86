...
<div id = "container">
<form name="inventoryInsert" action="${pageContext.request.contextPath}/inventoryInsert.do" method="post">
	<div id = "ribbon">
		<div id="ribbonMap">
			홈 > 재고관리 > 전체재고 > 등록
		</div>
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/inventoryInsertForm.do'; return false;">REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/inventoryList.do'; return false;">BACK</button>
		...
		<table id="companyTable">
			...
			<tr>
				...
				<c:forEach var="material" items="${materialList}">
					<option value="${material.materialId}" type-data="${material.materialType}">${material.materialName}</option>
				</c:forEach>
				</select>
				</td>				
				<th>제품번호</th>
			...
			<tr>
				...
				<th>제품유형</th>
				<td>
				<input type="text" id="materialType" name="materialType" readonly required>
				</td>
			</tr>
		</table>
	</div>
