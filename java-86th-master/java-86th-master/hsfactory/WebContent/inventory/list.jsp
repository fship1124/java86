...
<div id = "container">
	<div id = "ribbon">
		...
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/inventoryList.do'">REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/inventoryInsertForm.do'">+NEW</button>
		</div>
	</div>
