...
<div id = "container">
	<div id = "ribbon">
		...
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/completeMaterialInventoryList.do'; return false;">REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/completeMaterialInventoryInsertForm.do'; return false;">+NEW</button>
		</div>
	</div>
	...
	<div id = "content">
		<table id="companyTable">
			...
			<tr>
				...
				<td><a href="#" class="delTag" type-data="${inventory.inventoryId}">항목삭제</a></td>
			</tr>
			</c:forEach>
		</table>
	</div>	
...
<script>
	$(".delTag").click(function () {
		if (confirm("삭제하시겠습니까?")) {
			location.href="${pageContext.request.contextPath}/completeMaterialInventoryDelete.do?deleteInventoryId=" + $(this).attr("type-data");
		};
	});
</script>
