...
<div id = "container">
<form name="inventoryInsert" action="${pageContext.request.contextPath}/completeMaterialInventoryInsert.do" method="post">
	<div id = "ribbon">
		<div id="ribbonMap">
			홈 > 재고관리 > 완제품재고 > 등록
		</div>
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/completeMaterialInventoryInsertForm.do'; return false;">REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/completeMaterialInventoryList.do'; return false;">BACK</button>
