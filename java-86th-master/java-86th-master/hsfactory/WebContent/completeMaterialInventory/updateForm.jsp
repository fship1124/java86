...
<div id = "container">	
	<div id = "ribbon">
		...
		<div id="ribbonBtn">
			...
			<button onclick="location.href='${pageContext.request.contextPath}/completeMaterialInventoryList.do'; return false;">CANCEL</button>
		</div>
	</div>
		...
		<table id="companyTable">
			...
			<c:choose>
				<c:when test="${inventory.inventoryId == updateInventoryId}">
					<form action="${pageContext.request.contextPath}/completeMaterialInventoryUpdate.do">
					...
					<td><input type="submit" value="변경"/><input type="reset" value="재작성"/><input type="button" value="취소" onclick="location.href='${pageContext.request.contextPath}/completeMaterialInventoryList.do'; return false;"/></td>
					<td><a href="${pageContext.request.contextPath}/completeMaterialInventoryDelete.do?inventoryId=${inventory.inventoryId}">항목삭제</a></td>
					</form>
				</c:when>
				<c:otherwise>
					<td><c:out value="${inventory.inventoryId}" /></td>
					...
					<td><a href="${pageContext.request.contextPath}/completeMaterialInventoryUpdateForm.do?updateInventoryId=${inventory.inventoryId}">정보변경</a></td>
					<td><a href="${pageContext.request.contextPath}/completeMaterialInventoryDelete.do?deleteInventoryId=${inventory.inventoryId}">항목삭제</a></td>
				</c:otherwise>
			</c:choose>
