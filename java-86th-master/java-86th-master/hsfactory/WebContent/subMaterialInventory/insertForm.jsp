...
<div id = "container">
<form name="inventoryInsert" action="${pageContext.request.contextPath}/subMaterialInventoryInsert.do" method="post">
	<div id = "ribbon">
		<div id="ribbonMap">
			홈 > 재고관리 > 부자재재고 > 등록
		</div>
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/subMaterialInventoryInsertForm.do'; return false;">REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/subMaterialInventoryList.do'; return false;">BACK</button>
