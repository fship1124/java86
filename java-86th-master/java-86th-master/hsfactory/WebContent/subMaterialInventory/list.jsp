...
<div id = "container">
	<div id = "ribbon">
		...
		<div id="ribbonBtn">
			<button onclick="location.href='${pageContext.request.contextPath}/subMaterialInventoryList.do'; return false;">REFRESH</button>
			<button onclick="location.href='${pageContext.request.contextPath}/subMaterialInventoryInsertForm.do'; return false;">+NEW</button>
		</div>
	</div>
...
<script>
	$(".delTag").click(function () {
		if (confirm("삭제하시겠습니까?")) {
			location.href="${pageContext.request.contextPath}/subMaterialinventoryDelete.do?deleteInventoryId=" + $(this).attr("type-data");
		};
	});
</script>
