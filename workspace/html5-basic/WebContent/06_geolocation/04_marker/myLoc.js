...
function displayLocation(position) {
	...
	location.innerHTML = 
		"당신의 위치 : 위도(" + latitude + "), 경도(" + longitude + ")<br />" +
...
function showMap(coords) {
	...
	var content = 
		"위치(위도 : " + coords.latitude + ", 경도 : " + coords.longitude + ")";
	// 마커추가 함수 호출
...
function addMarker(map, latlng, title, content) {
	...
	var markerOption = {
		...
		map: map,			// 마커를 이 지도에 찍어준다
		title: title,       // 마커위에 마우스를 오버할 때 보여줄 툴팁
	...
	var infoWindowOptions = {
		content: content,	 //내용설정
		position: latlng	  //지도에 설정될 위치값
	}
