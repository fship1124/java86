...
function computeDistance(startCoords, destCoords) {
	var startLatRads  = degreesToRadians(startCoords.latitude );       // 위도경도에 대한 반지름
	var startLongRads = degreesToRadians(startCoords.longitude);       // 위도경도에 대한 반지름
