...
public class Download extends HttpServlet {
	...
	// 1. 다운로드 경우
	// http://localhost:8000/ServletJsp/down?
	// path=/2016/08/11&realName=349uug9849ug9u4.jpg&oriName=jeli.jpg
	// 2. 화면에 출력
	// http://localhost:8000/ServletJsp/down?
	// path=/2016/08/11&realName=349uug9849ug9u4.jpg&draw=Y
