...
//bodyParser 미들웨어를 위쪽에서 호출하기만 하면 request의 body의 정보를 쉽게 꺼낼수 있음
...
function write(request, response) {
  ...
  var sql = "insert into t86_board(writer, title, content) values(?, ?, ?)";
